...
from hwe import rest
from hwe.configuration import Configuration
from hwe.exceptions import ApiTypeError, ApiValueError, ApiException
from hwe.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = HomewizardApi()
        api_instance.api_get  # this is an instance of the class Endpoint
        api_instance.api_get()  # this invokes api_instance.api_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.api_get.callable or self.callable in this class
