...
class Basic(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_type, product_name, serial, firmware_version, api_version, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_type, product_name, serial, firmware_version, api_version, *args, **kwargs):  # noqa: E501
        """Basic - a model defined in OpenAPI
